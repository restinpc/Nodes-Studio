...
if( $_SERVER["HTTP_HTTPS"] == "on" || 
    ...
    mb_strpos($_SERVER["SCRIPT_URI"], "https") !== FALSE ||
...
if(strpos($_GET[0], "firebase-messaging-sw.js")!==FALSE) 
    $_GET[0] = str_replace("firebase-messaging-sw.js", "firebase.php", $_GET[0]);
