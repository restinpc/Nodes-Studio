...
if(!isset($_POST["jQuery"])){
    ...
    if($count>0){
        ...
        $header .= '<li><a href="'.$_SERVER["DIR"].'/order" id="purcases" class="hidden">'.lang("Cart").'<font class="purcases_count"></font></a></li>';
    }
...
<div class="container">
    ...
    if(!empty($_SESSION["user"]["id"])){
        ...
        . '<input type="button" class="btn 270" value="'.lang("Login").'" onClick="show_login_form();"  />';
    }$footer .= '
        </form>
        </div>
        <div class="clear"></div>
...
<section id="contentSection" class="pt10">';  
}else{ 
    $header .= ' 
